...
# pylint: skip-file
#
# Apologies Server documentation build configuration file, based on existing
...
# Insert Apologies Server path into the system.
...
htmlhelp_basename = "ApologiesServerdoc"
...
latex_documents = [(master_doc, "ApologiesServer.tex", "Apologies Server Documentation", "Kenneth J. Pronovici", "manual")]
...
man_pages = [(master_doc, "apologies-server", "Apologies Server Documentation", [author], 1)]
...
texinfo_documents = [
    (
        master_doc,
        "Apologies Server",
        "Apologies Server Documentation",
        author,
        "Apologies Server",
